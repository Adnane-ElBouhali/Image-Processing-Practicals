...
for Rayon in Rayons:
    ...
    ax[0, 0].imshow(ima, cmap='gray')
    ax[0, 0].set_title('Original image'+', r='+str(rayon))

    ax[0, 1].imshow(top, cmap='magma')
    ax[0, 1].set_title('Tophat filter'+', r='+str(rayon))

    ax[1, 0].imshow(lowt, cmap='magma')
    ax[1, 0].set_title('Low threshold'+', r='+str(rayon))

    ax[1, 1].imshow(hight, cmap='magma')
    ax[1, 1].set_title('High threshold'+', r='+str(rayon))

    ax[0, 2].imshow(hyst, cmap='magma')
    ax[0, 2].set_title('Hysteresis'+', r='+str(rayon))

    ax[1, 2].imshow(hight + hyst, cmap='magma')
    ax[1, 2].set_title('High + Hysteresis'+', r='+str(rayon))
